...
{
    internal class FourthWeekNpsPhoneCallPlugin : IPlugin
    {
        private const string C_EntityName = "new_vehiclefiles";
        private const string C_ImageName = "Image";
        private const string C_FourthWeekNpsFlagFieldName = "new_fourweeknps";
        ...
        {
            if (vehicle.Contains(C_FourthWeekNpsFlagFieldName) == true)
            {
                return (bool)vehicle[C_FourthWeekNpsFlagFieldName];
            }
            else
            {
                return null;
